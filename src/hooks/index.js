 ...
 */
import { useContext, useEffect, useCallback, useModal, useState, useRef } from 'react';
...
export function useCustomPrompt(messageObj, shouldPrompt) {
